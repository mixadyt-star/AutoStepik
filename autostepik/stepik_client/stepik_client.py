...
class StepikClient(ABC):
    ...
    @abstractmethod
    def create_new_solution(self, attempt_id: int, code: Optional[str] = None, choices: Optional[List[bool]] = None, text: Optional[str] = None, ordering: Optional[List[int]] = None) -> NoReturn: ...
