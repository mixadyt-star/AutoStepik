    ...
    def generate_prompt(self, step, attempt, task_type):
        match task_type:
            ...
            case "table":
                ...
                "САМОЕ ВАЖНОЕ: ОБЯЗАТЕЛЬНО Распиши как ты пришёл к этому ответу и проверь себя. " \
                "Тебе нужно ответить на вопросы исходя из условия. " \
                "В ответe должен присутствовать объяснение решения и json вида: [{'name_row': '<code>True and False</code>', 'columns': [{'name': '<code>True</code>', 'answer': true}, {'name': '<code>False</code>', 'answer': false}]}, ...] и занеси его в теги <answer>...</answer>. " \
