    ...
    def generate_prompt(self, step, attempt, task_type):
        match task_type:
            case "code":
                ...
                "В ответe должен присутствовать код решения. КОД РЕШЕНИЯ СТО ПРОЦЕНТНО ДОЛЖЕН БЫТЬ В ТЕГАХ <answer>...</answer>!!! " \
            ...
            case "choice":
                ...
                "В ответe должен присутствовать json вида: [false, true, true, false] и занеси его в теги <answer>...</answer>. " \
            ...
            case "string":
                ...
                "В ответe должен присутствовать ответ решения ОБЫЧНЫМ ТЕКСТОМ БЕЗ МАРКДАУНА и занеси его в теги <answer>...</answer>. " \
                f"Вот условие задачи: {step.block.text}" \
                f"Также вот дополнительная информация о задаче: {str(step.block.options)}"
            ...
            case "sorting":
                ...
                "В ответe должен присутствовать json вида: [0, 3, 2, 1] и занеси его в теги <answer>...</answer>. " \
            ...
            case "fill-blanks":
                ...
                "В ответe должен присутствовать json вида: ['answer1', 'answer2'] и занеси его в теги <answer>...</answer>. " \
            ...
            case "number":
                ...
                "В ответe должен присутствовать число и занеси его в теги <answer>...</answer>. " \
                f"Вот условие задачи: {step.block.text} " \
                f"Также вот дополнительная информация о задаче: {str(step.block.options)}"
            
            case "table":
                return "Сейчас я дам тебе условие задачи на заполнение таблицы. " \
                "САМОЕ ВАЖНОЕ: ОБЯЗАТЕЛЬНО Распиши как ты пришёл к этому ответу и проверь себя. " \
                "Тебе нужно ответить на вопросы исходя из условия. " \
                "В ответe должен присутствовать json вида: [{'name_row': '<code>True and False</code>', 'columns': [{'name': '<code>True</code>', 'answer': true}, {'name': '<code>False</code>', 'answer': false}]}, ...] и занеси его в теги <answer>...</answer>. " \
                "Тебе будут даны строки и колонки и ты должен будешь для кадой строки подобрать свою колонку / колонки. " \
                "Ещё ты ОБЯЗАТЕЛЬНО должен заполнить все строки значениями. " \
                f"Вот условие задачи: {step.block.text} " \
                f"Вот строки и колнки, которые ты должен заполнить: {str(attempt.dataset)} " \
                f"Также вот дополнительная информация о задаче: {str(step.block.options)}"